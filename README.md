...
- [couchbase_magma](https://github.com/fivetran/fivetran_connector_sdk/blob/main/examples/source_examples/couchbase_magma) - This example shows how to sync data from self-managed Couchbase Server using Magma storage engine, with Connector SDK. You need to provide your Couchbase credentials for this example to work.
