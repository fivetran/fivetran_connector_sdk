...
- [netprint](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/Netprint-connector) - This is a simple example of how to sync data from Netprint API using Connector SDK. 
