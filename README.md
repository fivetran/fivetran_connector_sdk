...
- [healthchecks](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/healthchecks) - This example shows how to sync health check monitoring data from Healthchecks.io by using Connector SDK. You need to provide your Healthchecks.io API key for this example to work.
