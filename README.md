...
- [customer_thermometer](https://app.customerthermometer.com/api.php) - This is an example to show how to sync customer feedback data from Customer Thermometer's API by using Connector SDK. You need to provide your Customer Thermometer API key for this example to work.
