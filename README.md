...
- [deltek](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/deltek) - This example shows how to sync projects, project resources, and teams data from Deltek ConceptShare API by using Connector SDK. You need to provide your Deltek ConceptShare API key for this example to work.
