...
- [sensource](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/sensource) - This example syncs traffic and occupancy data from the Sensource API.
