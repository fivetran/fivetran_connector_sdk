...
- [bright_data_scrape](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/bright_data_scrape) - This is an example of how we can connect and sync data from Bright Data by using Connector SDK. You need to provide your Bright Data API token for the connector to work.
