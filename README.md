...
- Redshift
  ...
  - [using_unload](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/redshift/using_unload) - This example shows how to sync data from Redshift using the UNLOAD to S3 feature of Redshift with Connector SDK. You need to provide your Redshift and S3 credentials for this example to work.
