...
- [databricks-fm-fda-drug-label-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-fda-drug-label-intelligence) - Syncs FDA drug labeling data with AI analysis using Databricks ai_query(). Simple enrichment pattern.
- [databricks-fm-sec-edgar-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-sec-edgar-risk-intelligence) - Syncs SEC EDGAR filings with agent-driven discovery of related companies for credit risk.
- [databricks-fm-cpsc-product-safety-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-cpsc-product-safety-intelligence) - Syncs CPSC recalls with multi-agent debate (Safety vs Quality).
- [databricks-fm-noaa-weather-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-noaa-weather-risk-intelligence) - Syncs NOAA weather alerts with hybrid discovery + debate.
- [databricks-fm-fda-faers-pv-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-fda-faers-pv-intelligence) - Syncs FDA adverse events (FAERS) with PV debate: Safety Advocate vs Clinical Realist.
