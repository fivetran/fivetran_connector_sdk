...
- [egnyte](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/egnyte) - This example shows how to sync user data, group information, notes, and bookmarks from the Egnyte cloud storage platform by using the Connector SDK. You need to provide your Egnyte API token and domain for this example to work.
