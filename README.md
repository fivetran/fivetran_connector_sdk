...
- [datacamp](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/datacamp) - This example shows how to sync course catalog data from DataCamp's LMS Catalog API by using the Connector SDK. You need to provide your DataCamp bearer token for this example to work.
