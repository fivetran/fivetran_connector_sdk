...
- [nextdoor_api](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/nextdoor_api) - This example shows how to sync city, state, and trending post data from the Nextdoor API by using Connector SDK. You need to provide your Nextdoor API key for this example to work.
