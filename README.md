...
- [raven_db](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/raven_db) - This connector integrates RavenDB with Fivetran, syncing data from RavenDB collections to your destination. It connects to a RavenDB cluster, efficiently retrieves data using pagination, and handles incremental updates based on the `@last-modified` metadata field.
  ...
  - You need to provide your RavenDB credentials for this example to work.
- Redshift
