...
- [prefect_cloud](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/prefect_cloud) - This example shows how to sync flow run data from Prefect Cloud using Connector SDK. You need to provide your Prefect Cloud API key and workspace ID for this example to work.
