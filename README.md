...
- [rotamaster](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/rotamaster) - This example shows how to sync employee data, team information, and role definitions from the Rotamaster API by using Connector SDK. You need to provide your Rotamaster API key for this example to work.
