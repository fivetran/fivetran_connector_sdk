...
- [xurrent](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/xurrent) - This example shows how to sync organizations, products, and projects data from Xurrent API using Connector SDK. You need to provide your Xurrent API key and account ID for this example to work.
