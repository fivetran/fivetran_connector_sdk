...
- [marqeta](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/marqeta) - This example shows how to sync users, businesses, and transactions data from Marqeta Core API by using Connector SDK. You need to provide your Marqeta API username and password for this example to work.
