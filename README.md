...
- [dotdigital](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/dotdigital) - This example shows how to sync data from Dotdigital marketing automation platform using Connector SDK. You need to provide your Dotdigital API credentials for this example to work.
