...
- [sap_ariba](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/sap_ariba) - This example shows how to use the Connector SDK to integrate with SAP Ariba and sync procurement data for your organization.- [SAP HANA SQL](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/sap_hana_sql) - This example uses hdbcli to connect to SAP HANA SQL Server for syncing data using Connector SDK. You need to provide your SAP HANA SQL Server credentials for this example to work.
