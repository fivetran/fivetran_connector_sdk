...
- [aroflo](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/aroflo) - This example shows how to sync users, suppliers, and payments data from AroFlo's field service management platform using Connector SDK. You need to provide your AroFlo API key for this example to work.
