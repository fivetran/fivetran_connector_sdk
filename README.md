...
- [dentally](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/dentally) - This example shows how to sync dental practice management data from Dentally's API including practice sites, treatment rooms, and treatment procedures by using Connector SDK. You need to provide your Dentally credentials for this example to work.
