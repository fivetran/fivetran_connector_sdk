...
- [ticketmaster](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/ticketmaster) - This example shows how to sync data from the Ticketmaster API using the Connector SDK. You need to provide your Ticketmaster API key for this example to work.
