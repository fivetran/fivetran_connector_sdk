...
- [paylocity](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/paylocity) - This example shows how to sync employee data, payroll information, and HR data from Paylocity's API using the Fivetran Connector SDK. You need to provide your Paylocity credentials for this example to work.
