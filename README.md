...
- [ganus_graph](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/ganus_graph) - This example shows how to sync data from Ganus Graph database using Connector SDK. You need to provide your Ganus Graph credentials for this example to work.
