...
- [sam_gov](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/sam_gov) - This example shows how to sync government contracting opportunities from the SAM.gov (System for Award Management) API using Connector SDK. It demonstrates incremental sync with a sliding window strategy, pagination support for large datasets, and normalized data structure with breakout tables. You need to provide your SAM.gov API key for this example to work.
