...
- [sap_sybase_ase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/sap_sybase_ase) - This example shows how to connect and sync data from SAP Sybase ASE instance using Connector SDK. It uses the `pyodbc` library to connect to the Sybase ASE database and fetch data. You need to provide your Sybase ASE credentials for this example to work.
