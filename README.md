...
- [tulip_interfaces](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/tulip_interfaces) - Syncs data from Tulip Tables to Fivetran locations. Tulip is frontline operations platform. You need a Tulip instance with permissions to create API keys for the example to work.
- veeva vault
