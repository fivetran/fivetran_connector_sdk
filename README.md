...
- [langs_smith](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/langs_smith) - This example shows how to sync data from LangSmith API using Connector SDK. It retrieves datasets, examples, and run records from LangSmith and syncs them into your Fivetran destination.
