...
- [humaans](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/humaans) - This example shows how to sync companies, documents, and job-roles data from Humaans API by using Connector SDK. You need to provide your Humaans API token for this example to work.
