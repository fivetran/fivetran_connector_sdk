...
- [easyship](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/easyship) - This example shows how to sync boxes, manifests, and pickups data from Easyship API by using Connector SDK. You need to provide your Easyship API key for this example to work.
