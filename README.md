...
- [databricks-fm-fda-drug-label-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-fda-drug-label-intelligence) - Syncs FDA drug labeling data and enriches each label with AI analysis using Databricks ai_query() with Claude Sonnet 4.6. Optional Genie Space creation. First Databricks AI tutorial — simple enrichment pattern.
- [databricks-fm-sec-edgar-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-sec-edgar-risk-intelligence) - Syncs SEC EDGAR financial filing data with AI-powered credit risk analysis using agent-driven discovery. The AI recommends related companies to investigate for systemic risk. Second Databricks AI tutorial.
- [databricks-fm-cpsc-product-safety-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-cpsc-product-safety-intelligence) - Syncs CPSC product recall data with multi-agent debate analysis: Product Safety Analyst vs Manufacturing Quality Engineer with disagreement flags. Third Databricks AI tutorial.
- [databricks-fm-noaa-weather-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-noaa-weather-risk-intelligence) - Syncs NOAA weather alerts with hybrid analysis combining agent-driven discovery (identifying related regions) and multi-agent debate (Emergency Response vs Resource Planning). The capstone fourth Databricks AI tutorial.
