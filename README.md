...
- [planday](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/planday) - This example shows how to sync employee, department, and skills data from Planday HR API by using Connector SDK. You need to provide your Planday HR API key for this example to work.
