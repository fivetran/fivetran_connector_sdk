...
- [omnisend](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/omnisend) - This example shows how to sync products, contacts, and campaigns data from Omnisend API by using Connector SDK. You need to provide your Omnisend API key for this example to work.
