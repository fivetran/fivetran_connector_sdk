...
- [supabase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/supabase) - This example shows how to sync employee data from a Supabase database by using Connector SDK. You need to provide your Supabase project URL and API key for this example to work.
