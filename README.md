...
- [aftership](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/aftership) - This example shows how to sync package tracking and courier data from the AfterShip API to your data warehouse using Connector SDK. You need to provide your AfterShip API key for this example to work.
