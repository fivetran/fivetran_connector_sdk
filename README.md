...
- [kustomer](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/kustomer) - This example shows how to sync customer experience data from the Kustomer API by using Connector SDK. You need to provide your Kustomer API key for this example to work.
