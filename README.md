...
- [payscore](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/payscore) - This example shows how to sync data from PayScore API using Connector SDK. You need to provide your PayScore API key for this example to work.
