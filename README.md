...
- [dagster](https://github.com/fivetran/fivetran_connector_sdk/blob/main/connectors/dagster) - This example shows how to sync data from Dagster using Connector SDK. You need to provide your Dagster GraphQL API endpoint and API token for this example to work.
