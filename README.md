...
- [s3_glacier](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/s3_glacier) - This example shows how to sync data from Amazon S3 Glacier using Connector SDK. You need to provide your AWS S3 Glacier credentials for this example to work.
