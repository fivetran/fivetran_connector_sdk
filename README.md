...
- [datacamp](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/datacamp) - This is an example to show how to sync course catalog data from DataCamp's LMS Catalog API by using Connector SDK. You need to provide your DataCamp Bearer token for this example to work.
