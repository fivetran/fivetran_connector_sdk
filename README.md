...
- [quickbase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/quickbase) - This is an example of how to sync nightly report data from Quickbase using Connector SDK. You need to provide your Quickbase User token and Realm hostname for this example to work.
...
- [commonpaper](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/commonpaper) - This example shows how to sync agreement data from Common Paper using Connector SDK. You need to provide your Common Paper credentials for this example to work.
- [couchbase_capella](https://github.com/fivetran/fivetran_connector_sdk/blob/main/examples/source_examples/couchbase_capella) - This example shows how to sync data from Couchbase Capella using Connector SDK. You need to provide your Couchbase Capella credentials for this example to work.
- [couchbase_magma](https://github.com/fivetran/fivetran_connector_sdk/blob/main/examples/source_examples/couchbase_magma) - This example shows how to sync data from a self-managed Couchbase Server using the Magma storage engine with Connector SDK. You need to provide your Couchbase credentials for this example to work.
...
- [firebird_db](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/firebird_db) - This example shows how to sync data from Firebird DB using Connector SDK. You need to provide your Firebird DB credentials for this example to work.
...
- [harness_io](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/harness_io) - This example shows how to connect and sync data from Harness.io using Connector SDK. You need to provide your Harness API token and account ID for this example to work.
...
- [microsoft_intune](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/microsoft_intune/) - This example shows how to connect to Microsoft Intune and retrieve all managed devices using the Connector SDK.
...
- [oop_example](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/quickstart_examples/oop_example) - This example shows how to use object-oriented programming to build a connector for the National Parks Service API. It demonstrates how to create a class that encapsulates the logic for fetching data from the API and processing it.
- [quickbase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/quickbase) - This is an example of how to sync application and business data from the Quickbase API connector using Connector SDK. A user token is required to access the Quickbase API and retrieve data.
...
- [pindrop](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/pindrop) - This is an example of how to sync nightly report data from Pindrop using Connector SDK. You need to provide your Pindrop client ID and client Secret for this example to work.
- [quickbase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/quickbase) - The Quickbase API Connector is a Fivetran Connector SDK implementation that extracts comprehensive application and business data from Quickbase's REST API endpoints. A user token is required to access the Quickbase API and retrieve data.
...
- [SAP HANA SQL](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/sap_hana_sql) - This example uses hdbcli to connect to SAP HANA SQL Server for syncing data using Connector SDK. You need to provide your SAP HANA SQL Server credentials for this example to work.
...
- [talon_one](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/talon_one) - This is an example of how we can sync Talon.one events data using Connector SDK. You need to provide your Talon.one base url and api key for this example to work.
