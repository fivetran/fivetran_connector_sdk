...
- [meltwater](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/meltwater) - This example shows how to sync webhook configurations, saved searches, and tag definitions from Meltwater API by using Connector SDK. You need to provide your Meltwater API key for this example to work.
