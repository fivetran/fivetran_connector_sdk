...
- [netprint](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/netprint_connector) - This is a simple example of how to sync data from Netprint API using Connector SDK. 
