...
Please execute `.github/scripts/setup-hooks.sh` from the root of the repository to set up pre-commit hooks. This will ensure that your code is formatted correctly and passes all tests before you commit them.
