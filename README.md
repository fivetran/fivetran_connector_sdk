...
- [uber-eats](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/uber-eats) - This example shows how to sync data from Uber Eats API including stores, orders, promotions, and menu items using Connector SDK. You need to provide your Uber Eats API key for this example to work.
- veeva vault
