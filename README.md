...
- [shipwire](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/shipwire) - This example shows how to sync orders, purchase orders, and products data from the Shipwire API by using the Connector SDK. You need to provide your Shipwire API username and password for this example to work.
