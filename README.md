...
- [databricks-fm-fda-drug-label-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-fda-drug-label-intelligence) - Syncs FDA drug labeling data with AI analysis using Databricks ai_query(). Simple enrichment pattern. First Databricks AI tutorial.
- [databricks-fm-sec-edgar-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-sec-edgar-risk-intelligence) - Syncs SEC EDGAR filings with agent-driven discovery of related companies. Second Databricks AI tutorial.
- [databricks-fm-cpsc-product-safety-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-cpsc-product-safety-intelligence) - Syncs CPSC recalls with multi-agent debate (Safety vs Quality). Third Databricks AI tutorial.
- [databricks-fm-noaa-weather-risk-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-noaa-weather-risk-intelligence) - Syncs NOAA weather alerts with hybrid discovery + debate. Fourth Databricks AI tutorial.
- [databricks-fm-fda-faers-pv-intelligence](https://github.com/fivetran/fivetran_connector_sdk/tree/main/all_things_ai/tutorials/databricks-fm-fda-faers-pv-intelligence) - Syncs FDA adverse event reports (FAERS) with multi-agent debate for pharmacovigilance: Safety Advocate vs Clinical Realist with disagreement flags for PV team review. Pairs with the drug label connector for complete drug safety on Databricks.
