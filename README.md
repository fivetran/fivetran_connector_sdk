...
- [razorpay](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/razorpay) - This example shows how to sync orders, payments, settlements, and refunds data from Razorpay's payment gateway API by using Connector SDK. You need to provide your Razorpay API key and secret for this example to work.
- Redshift
