...
- [fireblocks](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/fireblocks) - This example shows how to sync vault accounts and wallet data from Fireblocks API to your data warehouse using Connector SDK. You need to provide your Fireblocks API key for this example to work.
