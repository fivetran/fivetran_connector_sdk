...
- [newrelic](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/newrelic) - This example shows how to sync data from New Relic API using Connector SDK. You need to provide your New Relic API key for this example to work.
