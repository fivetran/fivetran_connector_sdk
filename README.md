...
- [resend](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/resend) - This example shows how to sync email data from Resend's API using Connector SDK. It demonstrates incremental syncing based on email IDs, pagination handling for large datasets, comprehensive error handling with exponential backoff, and automatic flattening of nested JSON structures. You need to provide your Resend API token for this example to work.
- Redshift
