...
- [keycloak](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/keycloak) - This example shows how to sync identity and access management data from Keycloak Admin API including users, groups, roles, clients, and authentication events using Connector SDK. You need to provide your Keycloak server URL, realm, and OAuth2 client credentials for this example to work.
