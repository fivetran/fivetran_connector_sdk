...
- [supabase](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/supabase) - This example shows how to sync employee data from Supabase database by using Connector SDK. You need to provide your Supabase Project URL and API Key for this example to work.
