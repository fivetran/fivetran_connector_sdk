...
- [epic_caboodle](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/epic_caboodle) - This example shows how to sync healthcare data from Epic Caboodle using Connector SDK. It connects to Microsoft SQL server to sync the data. You need to provide your Epic server credentials for this example to work.
