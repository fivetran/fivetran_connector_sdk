...
- [fred](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/fred) - This example shows how to sync economic data from the Federal Reserve Economic Data (FRED) API using Connector SDK. It retrieves series metadata, time series observations, categories, and releases. You need to provide your FRED API key and series IDs for this example to work.
