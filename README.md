...
- [rillet](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/rillet) - This example shows how to use the Connector DSK to integrate with Rillet's API and sync accounting data. You need to provide the API key for this example to work.
