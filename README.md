...
- [serp_api_google_search](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/serp_api_google_search) - This example shows how to use the Connector SDK to obtain data from a specific keyword Google Search using SerpAPI.
