...
- [weights_and_biases](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/weights_and_biases) - This example shows how to sync machine learning experiment tracking data from Weights & Biases (W&B), including projects, runs (experiments), and artifacts (models and datasets). The connector uses the W&B Python SDK to retrieve data and implements robust error handling. You need to provide your W&B API key and entity name for this example to work.
