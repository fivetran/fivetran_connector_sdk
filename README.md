...
- [motionblend](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/motionblend) - This example shows how to catalog motion-capture (MoCap) file inventory from Google Cloud Storage and sync metadata to BigQuery for AI and animation pipelines. It demonstrates GCS blob iteration, stable record IDs using GCS object identifiers, incremental sync with bounded buffering for memory safety, and blend metadata calculation using the `blend_utils.py` module.
