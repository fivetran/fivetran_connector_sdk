...
- [listrak](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/listrak) - This example shows how to sync email marketing data from Listrak's API to your data warehouse by using Connector SDK. You need to provide your Listrak API key for this example to work.
