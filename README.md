...
- [tidb](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/tidb) - This is an example source connector that demonstrates incremental replication from TiDB databases into Fivetran destinations. It supports schema declaration, stateful checkpointing by `created_at`, and optional vector column parsing for JSON/vector payloads.
