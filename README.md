...
- [contentful-scim](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/contentful-scim) - This connector syncs user and group data from Contentful's SCIM API including user profiles and groups. You need to provide your Contentful SCIM API key and organization ID for this example to work.
