...
- [google_trends](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/google_trends) - This example shows how to sync search interest data from Google Trends using Connector SDK. It implements full refresh syncing with exponential retry logic, supports multiple keywords, regions, and timeframes, and tracks historical changes in search trends over time using append-only design.
