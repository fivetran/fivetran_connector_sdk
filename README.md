...
- [partech](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/partech) - This example shows how to sync location configuration and program metadata from the Partech (Punchh) Point of Sale API using Connector SDK. It demonstrates fetching location settings, loyalty program rules, redeemables, and redemption priorities. You need to provide your Partech location key and business key for this example to work.
- Redshift
