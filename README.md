...
- [motherduck](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/motherduck/) - This example shows how to connect to Motherduck using the Connector SDK.
