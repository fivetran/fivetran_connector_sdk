...
- [awardco](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/awardco) - This example shows how you can sync data from Awardco by using Connector SDK.  You will need to provide an API key for this example to work.
...
- [awardco](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/awardco) - This example shows how you can sync data from Awardco by using Connector SDK.  You need to provide your Awardco credentials for this example to work.
