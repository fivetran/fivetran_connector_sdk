...
- [dexory](https://github.com/fivetran/fivetran_connector_sdk/blob/main/connectors/dexory) - This example shows how to sync inventory data from Dexory's API by using Connector SDK.
