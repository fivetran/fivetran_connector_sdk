...
- [clerk](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/clerk) - This example shows how to sync users data from a Clerk database by using Connector SDK. You need to provide your Clerk project URL and API key for this example to work.
