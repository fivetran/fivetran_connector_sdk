...
- [coda_ai](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/coda_ai) - This connector demonstrates how to extract and sync data from **Coda Docs** using the **Fivetran Connector SDK**. It connects to the **Coda REST API (v1)**, authenticates via a Bearer token, and retrieves tables and rows from a specified Coda document.
