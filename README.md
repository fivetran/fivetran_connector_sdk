...
- [prefect](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/prefect) - This example shows how to sync workflow orchestration data from Prefect Cloud using Connector SDK. It fetches flows, deployments, work pools, work queues, flow runs, task runs, artifacts, and variables from the Prefect Cloud API with incremental syncing support. You need to provide your Prefect API key, account ID, and workspace ID for this example to work.
