...
- bright_data
  - [bright_data_scrape](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/bright_data_scrape) - This is an example of how we can connect and sync data from Bright Data by using Connector SDK. You need to provide your Bright Data api token for this to work.
  - [helpers](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/bright_data_scrape/helpers) - This is holds hepler files for bright data sync using Connector SDK.
