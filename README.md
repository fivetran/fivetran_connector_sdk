...
- [userflow](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/userflow) - This example shows how to sync user analytics data from Userflow's API by using Connector SDK. You need to provide your Userflow API key for this example to work.
