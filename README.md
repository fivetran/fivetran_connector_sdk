...
- [statuscake](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/statuscake) - This example shows how to sync uptime monitoring data from StatusCake's API by using Connector SDK. It fetches uptime test configurations, historical performance data, downtime periods, and alert information. You need to provide your StatusCake API key for this example to work.
