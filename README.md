...
- [people_ai](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/people_ai) - This is an example of how to sync activity and participants data from People AI using Connector SDK. You need to provide your People AI API key and secret for this example to work.
