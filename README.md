...
- [mastertax](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/mastertax) - This example shows how to sync data from MasterTax API using Connector SDK.
