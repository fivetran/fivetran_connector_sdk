...
- [contentful_uma](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/contentful_uma) - This example shows how to sync user, team, and organization data from Contentful User Management API using Connector SDK. You need to provide your Contentful User Management API credentials for this example to work.
