...
- [iterate](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/iterate) - This connector extracts NPS survey data from Iterate REST API and loads it into your Fivetran destination. The connector fetches NPS surveys and their individual responses, providing complete survey analytics data for downstream analysis.
