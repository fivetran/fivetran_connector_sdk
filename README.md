...
- [grey_hr](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/grey_hr) - This example shows how to sync Employee, Leave Transactions, and Attendance data from the greytHR API using the Connector SDK. It demonstrates OAuth2 client credentials authentication, automatic token refresh, incremental syncing, date windowing for API rate limits, and proper error handling with exponential backoff. Provide your greytHR API credentials for this example to work.
