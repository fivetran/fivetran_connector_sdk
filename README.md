...
- [countly](https://github.com/fivetran/fivetran_connector_sdk/blob/main/connectors/countly) - This example shows how to sync analytics data from Countly including apps, groups, and user profiles by using Connector SDK. You need to provide your Countly API key and app ID for this example to work.
