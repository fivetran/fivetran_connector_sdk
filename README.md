...
- [comet_opik](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/comet_opik) - This example shows how to sync data from Comet Opik using Connector SDK. You need to provide your Comet Opik API key for this example to work.
