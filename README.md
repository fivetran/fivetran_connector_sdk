...
- [gnews](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/gnews) - This is a simple example of how to sync data from GNews API using Connector SDK.
