...
- [bitbucket](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/bitbucket) - This example shows how to sync workspaces, repositories, and project data from Bitbucket API by using Connector SDK. You need to provide your Bitbucket username and app password for this example to work.
