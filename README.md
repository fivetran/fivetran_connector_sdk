...
- [SAP ARIBA](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/sap_ariba) - This example shows how to use the Connector SDK to integrate with SAP Ariba and sync procurement data for your organization.
