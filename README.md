...
- [rabbit_mq](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/rabbit_mq) - This connector demonstrates how to use the Fivetran Connector SDK to extract, process, and sync messages from RabbitMQ queues into a Fivetran destination.
- Redshift
