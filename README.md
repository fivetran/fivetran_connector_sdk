...
- [paligo](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/paligo) - This example shows how to sync users, taxonomies, and assignments data from the Paligo API to your destination warehouse. You need to provide your Paligo API credentials for this example to work.
