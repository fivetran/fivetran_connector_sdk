...
- [linear_api](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/linear_api) - This example shows how to sync data from Linear's GraphQL API using Connector SDK. It demonstrates isolated endpoint sync, incremental replication, soft delete detection, cursor-based pagination, and full checkpointing. You need to provide your Linear API key for this example to work.
