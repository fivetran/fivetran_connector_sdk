...
- [adform](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/adform) - The adform API Connector is a Fivetran Connector SDK implementation that extracts advertising campaign data by using Connector SDK.
