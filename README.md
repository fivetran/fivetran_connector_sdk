...
- [n8n](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/n8n) - This example shows how to sync workflow automation data from n8n including workflows and executions using Connector SDK. The connector implements incremental sync with cursor-based pagination and automatic retry logic with exponential backoff. You need to provide your n8n API key and base URL for this example to work.
