...
- [meilisearch](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/meilisearch) - This example shows how to sync index metadata and document data from MeiliSearch using Connector SDK. It fetches all indexes and their documents from your MeiliSearch instance, enabling analytics on search data, product catalogs, and user reviews. You need to provide your MeiliSearch API URL and API key for this example to work.
