...
- [gumroad](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/gumroad) - This example shows how to sync sales, products, subscribers, and payout data from Gumroad's API using Connector SDK. It supports incremental syncing for sales and payouts, handles pagination automatically, and flattens nested JSON objects into relational tables. You need to provide your Gumroad access token for this example to work.
