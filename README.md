...
- [astronomer_airflow](https://github.com/fivetran/fivetran_connector_sdk/tree/main/connectors/astronomer_airflow) - This example shows how to sync data from Astronomer Airflow using Connector SDK. You need to provide your Astronomer Airflow API key and base URL for this example to work.
