...
- [checkly](https://github.com/fivetran/fivetran_connector_sdk/tree/main/examples/source_examples/checkly) - This example shows how to sync monitoring check data and analytics from Checkly's API by using Connector SDK. You need to provide your Checkly API key and account ID for this example to work.
