...
This connector demonstrates how to fetch data from Bright Data's Web Scraper and
Web Unlocker APIs and upsert them into the Fivetran destination. The connector
...
def update(
    ...
    This function fetches data from Bright Data's Web Scraper and/or Web Unlocker APIs,
    ...
    Args:
        configuration: A dictionary containing connection details (api_token, scrape_url, unlocker_url, etc.)
