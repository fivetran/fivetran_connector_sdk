"""Schema management utilities for the SERP connector."""
...
TABLE_DESCRIPTION = (
    "Dynamically created table 'search_results' from Bright Data results. "
    "Fields are inferred from the API response structure."
)


def update_fields_yaml(fields: Set[str]) -> None:
    """Persist discovered search fields to fields.yaml."""
