...
Note: Messages are permanently removed from RabbitMQ after successful sync. Use dedicated analytical queues (DLQs, audit queues) - NOT production operational queues.
