...
The connector uses Fivetran SDK logging levels (`info`, `fine`, `warning`, `severe`) for detailed sync visibility.
...
- `menu`, `menu_item`, `menu_group`, `discounts`, `tables`, and others

### Nested children

- `orders_check_payment`, `orders_check_selection`, `orders_check_selection_modifier`, and others
