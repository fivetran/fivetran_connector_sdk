...
- [error_and_warning_operations](https://github.com/fivetran/connector_sdk/tree/main/examples/common_patterns/error_and_warning_operations) - This example shows a deterministic flow with two row-level warnings and one terminal primary-key error using a mock weather CSV source.
