...
def schema(configuration: dict):
    ...
    return [
        ...
        {
            "table": "zip_code_duplicate",  # Name of the table for zip code metadata
            "primary_key": ["zip_code"],  # Primary key column for the table.
        },
        {
            "table": "zip_code_second_duplicate",  # Name of the table for zip code metadata
            "primary_key": ["zip_code"],  # Primary key column for the table.
        },
    ]
...
def update(configuration: dict, state: dict):
    ...
    for zip_code in zip_codes:
        try:
            ...
            # The first argument is the name of the destination table.
            # The second argument is a dictionary containing the record to be upserted.
            op.upsert(table="zip_code_duplicate", data=metadata)

            # The 'upsert' operation is used to insert or update data in the destination table.
            # The first argument is the name of the destination table.
            # The second argument is a dictionary containing the record to be upserted.
            op.upsert(table="zip_code_second_duplicate", data=metadata)
