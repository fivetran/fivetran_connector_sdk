...
# Define the get_data function, which is a helper function that run API calls to get the records from each endpoint
...
def get_data(params: dict, os, endpoint, time_period, country_code):
    ...
    if os == "ios":
        f_params["app_ids"] = "6448311069, 6737597349, 6477489729, 6472538445, 1671705818, 1668000334, 6473753684"
    else:
        f_params["app_ids"] = "com.openai.chatgpt, com.deepseek.chat, com.google.android.apps.bard, com.microsoft.copilot, ai.character.app, ai.perplexity.app.android, com.anthropic.claude"
