...
def schema(configuration: dict):
    ...
    session_id = start_veeva_session(configuration)
    ...
    objects = get_vault_objects(configuration, session_id)
    schema_def = []
    seen = set()
    for obj in objects:
    ...
    end_veeva_session(configuration, session_id)
    return schema_def
...
def update(configuration: dict, state: dict):
    ...
    yield from sync_objects(base_url, objects, session_id, state)
